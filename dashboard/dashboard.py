...
# Catatan
st.markdown("*Catatan:*")
st.markdown("- Dashboard ini masih sederhana dan dapat dikembangkan lebih lanjut.")
st.markdown("- Data yang digunakan adalah data sampel dan mungkin tidak mencerminkan kondisi sebenarnya.")